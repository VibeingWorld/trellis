...
export type AppState = {workspaces: Workspace[];boards: Board[];columns: Column[];cards: Card[];placements: Placement[];tags: Tag[];cardTags: CardTag[];links: CardLink[];attachments: Attachment[];tray: TrayItem[];relations: CardRelation[];boardMembers:BoardMember[];memberOptions?:MemberOption[];authenticationDisabled:boolean;currentUser?:Omit<AppUser,'memberships'|'boardIds'>;permissionsByWorkspace?:Record<string,string[]>;users?:AppUser[]};
