...
export type WorkspaceIntegration={workspaceId:string;githubOwner:string|null;githubRepo:string|null;githubProjectUrl:string|null;codexProjectName:string|null;aiTriggerColumnId:string|null;updatedAt:number;githubConfigured:boolean;codexConfigured:boolean};
export type GithubLink={id:string;cardId:string;issueNumber:number;issueNodeId:string;issueUrl:string;issueTitle:string;projectItemId:string|null;createdAt:number;updatedAt:number};
export type AiRun={id:string;cardId:string;placementId:string;threadId:string|null;status:string;error:string|null;createdAt:number;updatedAt:number};
